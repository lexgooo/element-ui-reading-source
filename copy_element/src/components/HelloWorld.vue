<template>
  <div class="hello">
    ...
    <div class="button-group">
      ...
      <div>
        <lx-button-group>
          ...
          <lx-button type="primary" icon="lx-icon-delete" plain
            >按钮6</lx-button
          >
        </lx-button-group>
      </div>
    ...
    <div class="radio">
      ...
      <div>
        <h2>默认使用</h2>
        <lx-radio v-model="radio" label="1">单选框1</lx-radio>
        <lx-radio v-model="radio" label="2">单选框2</lx-radio>
      </div>
      <div>
        <h2>没有传入对应的 slot 文字</h2>
        <lx-radio v-model="radio1" label="标签1"></lx-radio>
        <lx-radio v-model="radio1" label="标签2"></lx-radio>
      </div>
      <div>
        <h2>单选框组</h2>
        <lx-radio-group v-model="radio2">
          <lx-radio label="标签2_1"></lx-radio>
          <lx-radio label="标签2_2"></lx-radio>
        </lx-radio-group>
      </div>
      <div>
        <h2>有边框</h2>
        <lx-radio v-model="radio1" label="标签1" border></lx-radio>
        <lx-radio v-model="radio1" label="标签2" border></lx-radio>
      </div>
      <div>
        <h2>禁用</h2>
        <lx-radio v-model="radio1" label="标签1" border></lx-radio>
        <lx-radio v-model="radio1" label="标签2" border disabled></lx-radio>
      </div>
      <div>
        <h2>单选框组-禁用</h2>
        <lx-radio-group v-model="radio2" disabled>
          <lx-radio label="标签2_1"></lx-radio>
          <lx-radio label="标签2_2"></lx-radio>
        </lx-radio-group>
      </div>
